...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent,bg='#632724')
        ...
        space_label = tk.Label(self,height=4,bg='#632724')
        space_label.pack()
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent,bg='#691B99')
        self.controller = controller
        ...
        button_frame = tk.Frame(self,bg='#8E24AA')
        ...
        withdraw_button = tk.Button(button_frame,
                                                            ...
                                                            width=50,
                                                            height=5)
        withdraw_button.grid(row=1,column=10,pady=5)
        ...
        deposit_button = tk.Button(button_frame,
                                                            ...
                                                            width=50,
                                                            height=5)
        deposit_button.grid(row=2,column=10,pady=5)
        ...
        balance_button = tk.Button(button_frame,
                                                            ...
                                                            width=50,
                                                            height=5)
        balance_button.grid(row=3,column=10,pady=5)
        ...
        exit_button = tk.Button(button_frame,
                                                            ...
                                                            height=5,
                                                            justify='center')
        exit_button.grid(row=5,column=10,pady=5)
